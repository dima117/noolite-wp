...
namespace NooliteSmartHome.Gateway.Encodings
{
    /// <summary>
    ...
    public abstract class BaseSingleByteEncoding : Encoding
    {
        ...
        /// </summary>
        private static BaseSingleByteEncoding[] _encodings;
        ...
        {
            _encodings = Assembly.GetExecutingAssembly().GetExportedTypes()
        ...
        public static Encoding GetEncoding(int codePage)
        {
            ...
            return _encodings.FirstOrDefault(t => t.CodePage == codePage);
        }
        ...
        public static new Encoding GetEncoding(string webName)
        {
            ...
            return _encodings.FirstOrDefault(t => string.Compare(webName, t.WebName, StringComparison.InvariantCultureIgnoreCase) == 0);
        }
